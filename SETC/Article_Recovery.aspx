<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Article_Recovery.aspx.cs" Inherits="Article_Recovery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">
        当前位置：<a href="Article_Recycle.aspx">回收站</a> >> <a href="#">恢复文章</a>
    </div>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <p>&nbsp;</p>
            <h4 style="color: red;">您确定要恢复以下文章吗？</h4>
            <p>&nbsp;</p>
            <div>
                <asp:Button ID="Button1" runat="server" Text="确定恢复"
                    ...
                    <div class="col-lg-15">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">恢复文章</span>
                            </div>
                            <!--Widget Header-->
