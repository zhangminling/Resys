...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="CurrentPosition">当前位置：<a href="#">文章模块</a> >>  <a href="Article_Add.aspx">新建文章</a>>>  <a href="Article_Man.aspx">文章管理</a></div>
        ...
        <ContentTemplate>
                                ...
                                <div class=" col-xs-10 col-md-10">
                                    ...
                                    <asp:Button ID="DelBtn" runat="server" Text="移至回收站" class="btn btn-warning"
                                     ...
                                     <asp:Button ID="PassBtn" runat="server" Text="通过审核" class="btn btn-danger"
                                        OnClick="PassBtn_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="NoPassBtn" runat="server" Text="不通过审核" class="btn btn-danger" 
                                ...
                                <div id="RightContent">
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="LDT" HeaderText="最后更新日期 " DataFormatString="{0:yy-MM-dd}" ItemStyle-Width="90" />
