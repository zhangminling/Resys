<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Article_Audit.aspx.cs" Inherits="Article_Audit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="CurrentPosition">当前位置：<a href="#">文章模块</a> >> <a href="Article_Audit.aspx">审核文章</a></div>
     ...
     <asp:Label ID="IDS" runat="server"  Text="" Visible="false"></asp:Label>
        ...
        <ContentTemplate>
                                <div id="Man_Nav">
                                    ...
                                    &nbsp;&nbsp;
                                    <asp:DropDownList ID="PassDDL" runat="server"
                                        OnSelectedIndexChanged="PassDDL_SelectedIndexChanged"
                                        AutoPostBack="True"> 
                                ...
                                <div class=" col-xs-10 col-md-10">
                                    ...
                                    <asp:Button ID="DelBtn" runat="server" Text="删除" class="btn btn-danger"
                                        OnClick="DelBtn_Click"  OnClientClick="return confirm('确定删除文章？')"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="PassBtn" runat="server" Text="通过审核" class="btn btn-success"
                                        OnClick="PassBtn_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="NoPassBtn" runat="server" Text="不通过审核" class="btn btn-warning"
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="ID"
                                                ...
                                                HeaderText="标题" ItemStyle-Width="300" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Target="_blank"></asp:HyperLinkField>
                                            ...
                                            <asp:BoundField DataField="StatusName" HeaderText="状态" ItemStyle-Width="45" />
